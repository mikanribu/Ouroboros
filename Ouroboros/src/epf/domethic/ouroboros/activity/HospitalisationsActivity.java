...
public class HospitalisationsActivity extends Activity {
    ...
    private LinearLayout MenuList; //The layout where the menu is written in activity_main.xml
    private int screenWidth;//The size of the screen
    private boolean isExpanded;//The configuration of the menu: collapsed or expanded
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setHomeButtonEnabled(true); // The icone_launcher will not go back automatically to home. (API min 14)
        
        MenuList = (LinearLayout) findViewById(R.id.slideMenu);//rely the menu to the corresponding layout
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem){
    	...
    	case android.R.id.home:// When the user click on the icone_launcher
    		if (isExpanded) {// If the menu is visible
                isExpanded = false;
                //0,12 corresponds to the size of the menu compare to the screen
                //Move MenuList from 12% of the screenwidth to 0 in 20.
                MenuList.startAnimation(new CollapseAnimation(MenuList, 0,(int)(screenWidth*0.12), 20)); 
            }else {// If the menu is invisible
                isExpanded = true;
                //Move MenuList from 0 to 12% of the screenwidth in 20.
                MenuList.startAnimation(new ExpandAnimation(MenuList, 0,(int)(screenWidth*0.12), 20));
            }
    		return true;
    	}
